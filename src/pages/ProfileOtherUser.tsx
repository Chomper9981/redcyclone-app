...
import UserHeader from '@/components/UserHeader'; // Sử dụng UserHeader thay vì ProfileUserHeader
...
// NotificationList không cần thiết vì tab Thông báo đã bị loại bỏ

const ProfileOtherUser: React.FC = () => {
  const [mainTab, setMainTab] = useState("news"); // State cho 4 tab chính
  const [subTab, setSubTab] = useState("latest"); // State cho 2 tab phụ
  ...
  const otherUser = {
    ...
    avatarUrl: "https://avatars.githubusercontent.com/u/9919?s=200&v=4", // Avatar khác
    followers: 5432,
    likes: 9876
  };
  ...
  const profileMainTabOptions = [
    ...
    { value: "following", label: "Được theo dõi" }, // "Được theo dõi" ở đây là danh sách người mà người dùng này đang theo dõi
  ];
